...
public class Controller {
    ...
    public void initialize() {
        ...
        Map<String, City> CityMap = loadCities(new File("./Comp261-Assignment-3/data/node.csv"));
        Map<String, Edge> lines = loadLines(new File("./Comp261-Assignment-3/data/edge.csv"), CityMap);
